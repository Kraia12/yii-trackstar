...
class ProjectTest extends CDbTestCase
{
	...
	{
		$project = $this->projects('project1');
		$this->assertEquals(array('member' =>'member','owner' =>'owner','reader' =>'reader'),$project->getUserRoleOptions());
	}
	...
	public function testAssociateUserToProject()
	{
		...
		$project = $this->projects('project2');
		$this->assertEquals(1,$project->associateUserToProject($user));
	}
	...
	public function testIsUserInProject()
	{
		$user = $this->users('user2');
		$project = $this->projects('project1');
		$this->assertTrue($project->isUserInProject($user));
	}
}